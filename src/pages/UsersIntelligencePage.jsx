      ...
      <main className="mt-6 flex min-h-0 flex-1 flex-col gap-6">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            <div className="flex items-center gap-2 text-amber-400">
              ...
              <h1 className="text-2xl font-bold text-white">Users Intelligence</h1>
            </div>
            <p className="mt-1 text-sm text-slate-400">
              Device registry, user detail, and block controls (additive — does not change billing).
            </p>
          </div>
        </div>
        ...
        {summary ? (
          <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
            <CounterCard label="Total devices ever seen" value={summary.totalDevicesEverSeen} />
